...
import com.FRCCompetitionMap.Requests.FRC.ParsedData.EventData.Team;
...
class QualificationPanel extends JPanel {
    private static class MatchDisplay extends JPanel {
...
class TeamsPanel extends JPanel {
    ...
    private static class TeamDisplay extends JPanel {
    ...
    public TeamsPanel() {
        super(null);
        setBackground(UIManager.getColor("background.darkerSubpage"));
    }
}